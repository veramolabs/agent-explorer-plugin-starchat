...
export const CredentialVerificationView = ({ verifyResult, credential } : { verifyResult: IVerifyResult, credential?: VerifiableCredential }) => {
  ...
  return <div>
    ...
    {verifyResult.verified && credential && <div className="veramo__verification_result_footer" >
      <svg
